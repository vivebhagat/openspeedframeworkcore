...
{
    public class AddWidgetDataCommand : ICommand    
    {
    ...
    public class AddWidgetDataCommandHandler : ICommandHandler<AddWidgetDataCommand>
    {
        public IUserContext userContext { get; set; }
        public IAccountContext accountContext { get; set; }
        public IModelContext db { get; set; }
        public AddWidgetDataCommandHandler(IModelContext db, IUserContext userContext, IAccountContext accountContext)
        {
            this.db = db;
        ...
        public async Task Handle(AddWidgetDataCommand command)
        {
            ...
            */
            ...
            this.db.WidgetDatas.Add(widgetData);
            this.db.SaveChanges();
