...
namespace SpeedFramework.APILib.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        [AllowAnonymous]
        [HttpPost]
        public async Task<IActionResult> RegisterId(UserModel userModel)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            string result = await _repo.RegisterUserId(userModel);
        ...
        private class ExternalLoginData
        {
            ...
            public static ExternalLoginData FromIdentity(ClaimsIdentity identity)
            {
                ...
                return new ExternalLoginData
                {
                    ...
                    ExternalAccessToken = identity.Claims.FirstOrDefault().Value,
                };
            }
        }
